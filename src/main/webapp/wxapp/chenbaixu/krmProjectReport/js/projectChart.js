...
function tableStarted() {
    layui.use(['layer', 'jquery', 'form'], function () {
        ...
        form.on('select(chartChange)', function (data) {
            switch (data.value) {
                case '0': $("[name='chartAll']").hide(); $("#profitabilityChart").show(); tipsOne(); break;
                case '1': $("[name='chartAll']").hide(); $("#incomeChart").show(); tipsTwo(); break;
                case '2': $("[name='chartAll']").hide(); $("#saveChart").show(); tipsThree(); break;
                case '3': $("[name='chartAll']").hide(); $("#insertOutputChart").show(); tipsFour(); break;
                case '4': $("[name='chartAll']").hide(); $("#savingsRanking").show(); tipsFive(); break;
                case '4': $("[name='chartAll']").hide(); $("#savingsRealPoint").show(); tipsSix(); break;
            }
            form.render('select');
