package com.boot.web.codegen.parse.impl;
...
import com.boot.web.codegen.parse.IParse;
...
public class BeetlParseImpl implements IParse {
    ...
    static {
        try {
            ...
            fn.put("stringutil", "com.boot.util.beetl.function.StrutilFunction");
            fn.put("shiro", "com.boot.util.beetl.function.ShiroFunction");
            fn.put("num", "com.boot.util.beetl.function.AutoNoGenFunction");
            fn.put("dict", "com.boot.util.beetl.function.DictFunction");
            cfg.setFnPkgMap(fn);
