...
public class SendMessageTest {
   ...
   // @Test
    public static void testSendTextMessage(){
        //0.设置消息内容
        String content="赵祖龙：你的快递已到，请携带工卡前往邮件中心领取。\n出发前可查看" +
