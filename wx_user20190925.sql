...
-- Records of wx_user
-- ----------------------------
INSERT INTO `wx_user` VALUES ('姓名', '帐号', '别名', '职务', '部门', '性别', '手机', '座机', '个人邮箱', '地址', '企业简称', '激活状态', '禁用状态', '微工作台');
INSERT INTO `wx_user` VALUES ('陈柏旭', 'ChenBaiXu', '', '', '北京科瑞明软件有限公司', '男', '13870686850', '', '', '', '', '已激活', '', '已关注');
INSERT INTO `wx_user` VALUES ('陈威', 'BaiKaiShui', '', '', '北京科瑞明软件有限公司;', '男', '', '18643272292', '', '', '', '未激活', '', '已关注');
...
INSERT INTO `wx_user` VALUES ('廖燕方', 'LiaoYanFang', '', '', '北京科瑞明软件有限公司;北京科瑞明软件有限公司/工程部/广东农信监管报送驻场运维', '男', '13524040561', '', '', '', '', '未激活', '', '已关注');
...
INSERT INTO `wx_user` VALUES ('李骏翔', 'LiJunXiang', '', '', '北京科瑞明软件有限公司;北京科瑞明软件有限公司/工程部/南京银行MAST项目组', '男', '17601636979', '', '', '', '', '已激活', '', '已关注');
INSERT INTO `wx_user` VALUES ('凌云', 'XingYun', '', '', '北京科瑞明软件有限公司;北京科瑞明软件有限公司/市场部', '男', '13051860888', '', '', '', '', '已激活', '', '已关注');
...
INSERT INTO `wx_user` VALUES ('唐可焓', 'TangKeHan', '', '', '北京科瑞明软件有限公司;北京科瑞明软件有限公司/工程部/广东农信监管报送驻场运维', '男', '', '', '1870184215@qq.com', '', '', '未激活', '', '已关注');
